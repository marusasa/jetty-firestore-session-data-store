...
/**
 * Jetty SessionDataStore implementation where Google Cloud
 * Datastore (Firestore) is used as a persistent data store.
 * 
 * Note - This is not a complete implementation of the session.
 * 
 * When SessionData is created in the 'load(String id)' method,
 * parameters other than session id is ignored.
 * 
 * Some methods do nothing.
 */
public class JettyFirestoreDataStore implements SessionDataStore {

	private static final Logger logger = LoggerFactory.getLogger(JettyFirestoreDataStore.class.getName());
	...
	public SessionData load(String id) throws Exception {
		//----------------------------------------------------------------
		//This needs to be corrected to make it a complete implementation.
		//----------------------------------------------------------------
